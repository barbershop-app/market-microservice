...
namespace microservice.Web.API.Authentication
{
    public class JWTMiddleware
    {
        ...
        public async Task Invoke(HttpContext context, MarketContext dbContext)
        {
        ...
        private void AttachUserToContext(HttpContext context, MarketContext dbcontext, string token)
        {
            try
            {
